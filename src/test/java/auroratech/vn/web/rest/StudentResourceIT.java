...
import auroratech.vn.domain.Student;
import auroratech.vn.repository.StudentRepository;
...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().name(DEFAULT_NAME).mssv(DEFAULT_MSSV).address(DEFAULT_ADDRESS);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().name(UPDATED_NAME).mssv(UPDATED_MSSV).address(UPDATED_ADDRESS);
        return student;
    }
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getMssv()).isEqualTo(DEFAULT_MSSV);
    ...
    void putNewStudent() throws Exception {
        ...
        updatedStudent.name(UPDATED_NAME).mssv(UPDATED_MSSV).address(UPDATED_ADDRESS);
        ...
        assertThat(testStudent.getMssv()).isEqualTo(UPDATED_MSSV);
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.address(UPDATED_ADDRESS);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.name(UPDATED_NAME).mssv(UPDATED_MSSV).address(UPDATED_ADDRESS);
