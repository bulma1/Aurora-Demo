...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().name(DEFAULT_NAME).author(DEFAULT_AUTHOR).year(DEFAULT_YEAR);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().name(UPDATED_NAME).author(UPDATED_AUTHOR).year(UPDATED_YEAR);
        return book;
    }
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).author(UPDATED_AUTHOR).year(UPDATED_YEAR);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).author(UPDATED_AUTHOR).year(UPDATED_YEAR);
